...
void resnetModel(unsigned int L1Memory, unsigned int L2Memory, unsigned int L3Memory, unsigned int L3Flash)
{
    ...
    CNN_MatAdd("S18_MatAdd_8x39x39", 0, 2, 2, 2, 11, 11, 11, 1, 1, 1, 8, 8, 39, 39, KOP_MATADD);
    ...
    CNN_MatAddDynAdjust("S35_MatAdd_16x20x20", 0, 2, 2, 2,
                        11, 11, 10, 1, 1, 1, 
                        16, 16, 
                        20, 20, KOP_MATADD_DYNADJUST);
    ...
    CNN_MatAdd("S52_MatAdd_32x10x10", 0, 2, 2, 2, 11, 11, 11, 1, 1, 1, 32, 32, 10, 10, KOP_MATADD);
    ...
    CNN_LinearReLU("S73_Linear_7x64x2x2", 0, 2, 2,
                    2, 2, 11, 15, 15,
                    10, 1, 1, 1, 1, 256, 7, KOP_LINEAR, KOP_NONE);
    
    // generator for SOFTMAX_0_32
    CNN_SoftMax("S74_SoftMax", 0, 2, 2, 10, 15, 1, 1, 7, KOP_SOFTMAX);
...
#define GRAPH
    ...
    CreateGraph("resnetCNN",
        /* Arguments either passed or globals */
            CArgs(44,
                ...
                TCArgInfo("signed short * __restrict__", "Model_1conv1conv2d_bias", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_RESNET/tensors/Model_1conv1conv2d_bias.tensor", 1, 1, 16, 12)),
                ...
                TCArgInfo("signed short * __restrict__", "Res3bbranch2bkernel", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_RESNET/tensors/Res3bbranch2bkernel.tensor", 1, 1, 16, 15)),
    ...
    // Node S7_Conv2d_8x8x3x3_Relu inq 11 weightsq 15 outq 12 biasesq 13
    ...
    // Node S10_Conv2d_8x8x3x3 inq 12 weightsq 15 outq 12 biasesq 13
    ...
    // Node ADD_0_5 inq1 12 inq2 11 outq 11
    ...
    // Node S17_Conv2d_8x8x3x3 inq 12 weightsq 15 outq 11 biasesq 14
    ...
    // Node ADD_0_8 inq1 11 inq2 11 outq 11
    ...
    // Node S31_Conv2d_16x16x3x3_Relu inq 11 weightsq 15 outq 12 biasesq 14
    ...
    // Node S34_Conv2d_16x16x3x3 inq 12 weightsq 15 outq 11 biasesq 13
    ...
    // Node ADD_0_15 inq1 11 inq2 11 outq 10
    ...
    // Node S38_Conv2d_32x16x3x3_Relu inq 10 weightsq 15 outq 12 biasesq 14
    ...
    // Node S41_Conv2d_32x16x1x1 inq 10 weightsq 15 outq 11 biasesq 14
    ...
    // Node S44_Conv2d_32x32x3x3_Relu inq 12 weightsq 14 outq 12 biasesq 12
    ...
    // Node S51_Conv2d_32x32x3x3 inq 13 weightsq 14 outq 11 biasesq 13
    ...
    // Node ADD_0_22 inq1 11 inq2 11 outq 11
    ...
    // Node S55_Conv2d_64x32x3x3_Relu inq 11 weightsq 15 outq 12 biasesq 14
    ...
    // Node S58_Conv2d_64x32x1x1 inq 11 weightsq 15 outq 12 biasesq 15
    ...
    // Node S61_Conv2d_64x64x3x3_Relu inq 12 weightsq 14 outq 12 biasesq 13
    ...
    // Node ADD_0_26 inq1 12 inq2 12 outq 11
    ...
    // Node S65_Conv2d_64x64x3x3_Relu inq 11 weightsq 15 outq 13 biasesq 14
    ...
    // Node S68_Conv2d_64x64x3x3 inq 13 weightsq 15 outq 12 biasesq 14
    ...
    // Node ADD_0_29 inq1 12 inq2 11 outq 11
    ...
    // Node FULLY_CONNECTED_0_31 inq 11 weightsq 15 outq 10
    ...
    // Node SOFTMAX_0_32 inq 10 outq 15
