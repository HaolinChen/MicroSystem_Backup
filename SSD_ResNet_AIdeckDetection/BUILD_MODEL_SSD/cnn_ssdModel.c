...
#define GRAPH
    ...
    CreateGraph("cnn_ssdCNN",
        /* Arguments either passed or globals */
            CArgs(39,
                ...
                TCArgInfo("signed short * __restrict__", "Conv_0_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Conv_0_weights.tensor", 1, 1, 16, 12)),
                TCArgInfo("signed short * __restrict__", "Constant_103", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Constant_103.tensor", 1, 1, 16, 14)),
                TCArgInfo("signed short * __restrict__", "Conv_3_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Conv_3_weights.tensor", 1, 1, 16, 14)),
                TCArgInfo("signed short * __restrict__", "Constant_106", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Constant_106.tensor", 1, 1, 16, 13)),
                TCArgInfo("signed short * __restrict__", "Conv_6_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Conv_6_weights.tensor", 1, 1, 16, 15)),
                TCArgInfo("signed short * __restrict__", "Constant_109", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Constant_109.tensor", 1, 1, 16, 14)),
                TCArgInfo("signed short * __restrict__", "Conv_9_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Conv_9_weights.tensor", 1, 1, 16, 14)),
                TCArgInfo("signed short * __restrict__", "Constant_112", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Constant_112.tensor", 1, 1, 16, 13)),
                ...
                TCArgInfo("signed short * __restrict__", "Constant_classification_headers.0.bias", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Constant_classification_headers.0.bias.tensor", 1, 1, 16, 14)),
                ...
                TCArgInfo("signed short * __restrict__", "Constant_115", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Constant_115.tensor", 1, 1, 16, 13)),
                ...
                TCArgInfo("signed short * __restrict__", "Constant_118", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Constant_118.tensor", 1, 1, 16, 13)),
                TCArgInfo("signed short * __restrict__", "Conv_21_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Conv_21_weights.tensor", 1, 1, 16, 15)),
                ...
                TCArgInfo("signed short * __restrict__", "Conv_24_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Conv_24_weights.tensor", 1, 1, 16, 15)),
                TCArgInfo("signed short * __restrict__", "Constant_121", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Constant_121.tensor", 1, 1, 16, 13)),
                TCArgInfo("signed short * __restrict__", "Conv_26_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Conv_26_weights.tensor", 1, 1, 16, 15)),
                TCArgInfo("signed short * __restrict__", "Constant_classification_headers.3.bias", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Constant_classification_headers.3.bias.tensor", 1, 1, 16, 15)),
                TCArgInfo("signed short * __restrict__", "Conv_27_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Conv_27_weights.tensor", 1, 1, 16, 15)),
                TCArgInfo("signed short * __restrict__", "Constant_regression_headers.3.bias", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Constant_regression_headers.3.bias.tensor", 1, 1, 16, 15)),
    ...
    // Node S3_Conv2d_8x1x3x3_MaxPool_2x2_Relu inq 15 weightsq 12 outq 12 biasesq 14
    ...
    // Node S6_Conv2d_16x8x3x3_MaxPool_2x2_Relu inq 12 weightsq 14 outq 12 biasesq 13
    ...
    // Node S9_Conv2d_16x16x3x3_MaxPool_2x2_Relu inq 12 weightsq 15 outq 13 biasesq 14
    ...
    // Node S12_Conv2d_32x16x3x3_Relu inq 13 weightsq 14 outq 13 biasesq 13
    ...
    // Node MaxPool_13 inq Q3.13 outq Q3.13
    AddNode("S13_MaxPool_2x2", Bindings(2, GNodeArg(GNA_IN, "S12_Output", 0), GNodeArg(GNA_OUT, "S13_Output", 0)));
    // Node S16_Conv2d_18x32x3x3 inq 13 weightsq 14 outq 11 biasesq 14
    ...
    // Node S20_Conv2d_24x32x3x3 inq 13 weightsq 15 outq 12 biasesq 15
    ...
    // Node S24_Conv2d_64x32x3x3_Relu inq 13 weightsq 15 outq 13 biasesq 13
    ...
    // Node S40_Conv2d_18x128x3x3 inq 13 weightsq 15 outq 12 biasesq 15
    ...
    // Node S48_Conv2d_128x128x3x3_Relu inq 13 weightsq 15 outq 13 biasesq 13
    ...
    // Node S51_Conv2d_18x128x3x3 inq 13 weightsq 15 outq 12 biasesq 15
    ...
    // Node S55_Conv2d_24x128x3x3 inq 13 weightsq 15 outq 12 biasesq 15
