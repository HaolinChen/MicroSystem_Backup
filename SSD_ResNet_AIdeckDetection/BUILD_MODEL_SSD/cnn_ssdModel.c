...
#define GRAPH
    ...
    CreateGraph("cnn_ssdCNN",
        /* Arguments either passed or globals */
            CArgs(39,
                ...
                TCArgInfo("signed short * __restrict__", "Conv_0_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Conv_0_weights.tensor", 1, 1, 16, 11)),
                ...
                TCArgInfo("signed short * __restrict__", "Constant_106", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Constant_106.tensor", 1, 1, 16, 15)),
                ...
                TCArgInfo("signed short * __restrict__", "Constant_109", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Constant_109.tensor", 1, 1, 16, 13)),
                ...
                TCArgInfo("signed short * __restrict__", "Conv_21_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Conv_21_weights.tensor", 1, 1, 16, 13)),
                ...
                TCArgInfo("signed short * __restrict__", "Conv_22_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Conv_22_weights.tensor", 1, 1, 16, 14)),
                ...
                TCArgInfo("signed short * __restrict__", "Constant_121", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Constant_121.tensor", 1, 1, 16, 15)),
                TCArgInfo("signed short * __restrict__", "Conv_26_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_HFLASH, AT_MEM_UNDEF, ConstInfo("BUILD_MODEL_SSD/tensors/Conv_26_weights.tensor", 1, 1, 16, 14)),
    ...
    // Node S12_Conv2d_32x16x3x3_Relu inq 12 weightsq 14 outq 13 biasesq 13
    ...
    // Node S16_Conv2d_18x32x3x3 inq 13 weightsq 14 outq 11 biasesq 15
    ...
    // Node S36_Conv2d_128x64x3x3_Relu inq 13 weightsq 15 outq 14 biasesq 13
    ...
    // Node MaxPool_23 inq Q2.14 outq Q2.14
    AddNode("S37_MaxPool_2x2", Bindings(2, GNodeArg(GNA_IN, "S36_Output", 0), GNodeArg(GNA_OUT, "S37_Output", 0)));
    // Node S40_Conv2d_18x128x3x3 inq 14 weightsq 13 outq 11 biasesq 15
    ...
    // Node S44_Conv2d_24x128x3x3 inq 14 weightsq 14 outq 12 biasesq 15
    ...
    // Node S48_Conv2d_128x128x3x3_Relu inq 14 weightsq 15 outq 14 biasesq 15
    ...
    // Node S55_Conv2d_24x128x3x3 inq 14 weightsq 15 outq 14 biasesq 15
