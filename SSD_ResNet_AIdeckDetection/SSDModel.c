...
int main(int argc, char **argv)
{
    ...
    n_anchors = 6;
    GenerateSSD3Dto2D("SDD3Dto2DSoftmax_20_16_18", 20, 16, 18, n_classes,1);
    ...
    n_anchors = 6;
    GenerateSSD3Dto2D("SDD3Dto2DSoftmax_10_8_18", 10, 8, 18, n_classes,1);
    ...
    n_anchors = 6;
    GenerateSSD3Dto2D("SDD3Dto2DSoftmax_5_4_18", 5, 4, 18, n_classes,1);
    GenerateSSD3Dto2D("SDD3Dto2D_5_4_24",        5, 4, 24, n_classes,0);
    GeneratePredecoder("Predecoder5_4",          5, 4, n_anchors, n_offsets, n_classes);

    n_anchors = 6;
    GenerateSSD3Dto2D("SDD3Dto2DSoftmax_2_2_18",  2,  2, 18, n_classes,1);
