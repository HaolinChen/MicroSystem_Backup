...
int main(int argc, char **argv)
{
    ...
    n_anchors = 6;
    GenerateSSD3Dto2D("SDD3Dto2DSoftmax_20_16_12", 20, 16, 12, n_classes,1);
    ...
    n_anchors = 6;
    GenerateSSD3Dto2D("SDD3Dto2DSoftmax_10_8_12", 10, 8, 12, n_classes,1);
    ...
    n_anchors = 6;
    GenerateSSD3Dto2D("SDD3Dto2DSoftmax_5_4_12", 5, 4, 12, n_classes,1);
    GenerateSSD3Dto2D("SDD3Dto2D_5_4_24",        5, 4, 24, n_classes,0);
    GeneratePredecoder("Predecoder5_4",          5, 4, n_anchors, n_offsets, n_classes);

    n_anchors = 6;
    GenerateSSD3Dto2D("SDD3Dto2DSoftmax_2_2_12",  2,  2, 12, n_classes,1);
