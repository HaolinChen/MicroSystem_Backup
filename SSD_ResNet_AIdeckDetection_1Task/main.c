...
void writeDetImg(unsigned char *imageinchar, uint16_t Img_num, int16_t score)
{
    ...
    sprintf(imgName, "../../../OUTPUT/1task_2resize/%d_%f.ppm", Img_num, score_fp);
...
void writeDetImg_resnet(unsigned char *imageinchar, uint16_t Img_num, int outclass1)
{
    ...
    //Save Images to Local
    sprintf(imgName, "../../../OUTPUT/1task_2resize/%ld_class%d.ppm", Img_num, outclass1);
    printf("Dumping image %s\n", imgName);
...
static void RunSSD()
{
    ...
    SDD3Dto2DSoftmax_20_16_12(Output_1, tmp_buffer_classes, OUTPUT_1_Q, 2);
    ...
    SDD3Dto2DSoftmax_10_8_12(Output_3, tmp_buffer_classes, OUTPUT_3_Q, 2);
    ...
    SDD3Dto2DSoftmax_5_4_12(Output_5, tmp_buffer_classes, OUTPUT_5_Q, 2);
    ...
    SDD3Dto2DSoftmax_2_2_12(Output_7, tmp_buffer_classes, OUTPUT_7_Q, 2);
