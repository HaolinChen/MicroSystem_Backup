...
int main(int argc, char **argv)
{
    ...
    n_anchors = 6;
    GenerateSSD3Dto2D("SDD3Dto2DSoftmax_20_16_48", 20, 16, 48, n_classes,1);
    GenerateSSD3Dto2D("SDD3Dto2D_20_16_24",        20, 16, 24, n_classes,0);
    GeneratePredecoder("Predecoder20_16",          20, 16, n_anchors, n_offsets, n_classes);

    n_anchors = 6;
    GenerateSSD3Dto2D("SDD3Dto2DSoftmax_10_8_48", 10, 8, 48, n_classes,1);
    GenerateSSD3Dto2D("SDD3Dto2D_10_8_24",        10, 8, 24, n_classes,0);
    GeneratePredecoder("Predecoder10_8",          10, 8, n_anchors, n_offsets, n_classes);

    n_anchors = 6;
    GenerateSSD3Dto2D("SDD3Dto2DSoftmax_5_4_48", 5, 4, 48, n_classes,1);
    GenerateSSD3Dto2D("SDD3Dto2D_5_4_24",        5, 4, 24, n_classes,0);
    GeneratePredecoder("Predecoder5_4",          5, 4, n_anchors, n_offsets, n_classes);

    // n_anchors = 6;
    // GenerateSSD3Dto2D("SDD3Dto2DSoftmax_2_2_48",  2,  2, 48, n_classes,1);
    // GenerateSSD3Dto2D("SDD3Dto2D_2_2_24",         2,  2, 24, n_classes,0);
    // GeneratePredecoder("Predecoder2_2",           2,  2, n_anchors, n_offsets, n_classes);
