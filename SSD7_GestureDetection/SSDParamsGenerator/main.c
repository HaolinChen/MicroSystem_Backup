...
void Generate_anchor_layer_output(FILE * sf, FILE * hf, Alps * anchor_layer,int postFIX){
	...
	//Generate Function
	fprintf(hf,"int initAnchorLayer_%d();\n",postFIX);
...
void GenerateAnchorsLayer(){
	...
	float n_aspect_ratios_1[]= {1.,2.,1./2.,3.,1./3.};
 	float n_variances_1[]={0.1, 0.1, 0.2, 0.2};

	anchors_layer_1->feature_map_width  = 20;
    anchors_layer_1->feature_map_height = 16;
    anchors_layer_1->n_classes  = 8;
    anchors_layer_1->img_width  = 160;
    anchors_layer_1->img_height = 128;
    anchors_layer_1->this_scale = 0.2;
    anchors_layer_1->next_scale = 0.35;
    anchors_layer_1->anchor_params = 4;
    anchors_layer_1->iou_thr = 0.1;
    anchors_layer_1->step_height= NAN;        // Automatic assignment
 	anchors_layer_1->step_width = NAN;        // Automatic assignment
 	anchors_layer_1->offset_height = NAN;     // Automatic assignment
 	anchors_layer_1->offset_width  = NAN;     // Automatic assignment
 	anchors_layer_1->aspect_ratios = n_aspect_ratios_1;
 	anchors_layer_1->variances = n_variances_1;
 	anchors_layer_1->two_boxes_for_ar1 = true;
 	anchors_layer_1->max_bboxes = 20; //Is this used?
 	anchors_layer_1->n_confidence = 0;
 	anchors_layer_1->confidence_thr = CONFIDENCE_THR;           // it can be changed, more specifically after performance analysis.
 	anchors_layer_1->max_candidates_per_class = 20;  // it can be changed, more specifically after performance analysis and also for power consumption.
 	anchors_layer_1->n_aspect_ratios =	sizeof(n_aspect_ratios_1)/sizeof(n_aspect_ratios_1[0]);
 	anchors_layer_1->n_variances     =	sizeof(n_variances_1)/sizeof(n_variances_1[0]);
 	Anchor_layer_init(anchors_layer_1);             // initialize the layer with the information provided

	Generate_anchor_layer_output(source_file,header_file, anchors_layer_1, 1);
	...
	float n_aspect_ratios_2[]= {1.,2.,1./2.,3.,1./3.};
 	float n_variances_2[]={0.1, 0.1, 0.2, 0.2};

	anchors_layer_2->feature_map_width  = 10;
    anchors_layer_2->feature_map_height = 8;
    anchors_layer_2->n_classes  = 8;
    anchors_layer_2->img_width  = 160;
    anchors_layer_2->img_height = 128;
    anchors_layer_2->this_scale = 0.35;
    ...
    anchors_layer_2->step_height= NAN;        // Automatic assignment
 	...
 	anchors_layer_2->max_bboxes = 20; //Is this used?
	...
	float n_aspect_ratios_3[]= {1.,2.,1./2.,3.,1./3.};
 	float n_variances_3[]={0.1, 0.1, 0.2, 0.2};

	anchors_layer_3->feature_map_width  = 5;
    anchors_layer_3->feature_map_height = 4;
    anchors_layer_3->n_classes  = 8;
    anchors_layer_3->img_width  = 160;
    anchors_layer_3->img_height = 128;
    anchors_layer_3->this_scale = 0.5;
    anchors_layer_3->next_scale = 0.65;
    ...
    anchors_layer_3->step_height= NAN;        // Automatic assignment
 	...
 	anchors_layer_3->max_bboxes = 20; //Is this used?
	...
	// float n_aspect_ratios_4[]= {1.,2.,1./2.,3.,1./3.};
 	// float n_variances_4[]={0.1, 0.1, 0.2, 0.2};

	// anchors_layer_4->feature_map_width  = 2;
    // anchors_layer_4->feature_map_height = 2;
    // anchors_layer_4->n_classes  = 8;
    // anchors_layer_4->img_width  = 160;
    // anchors_layer_4->img_height = 128;
    // anchors_layer_4->this_scale = 0.65;
    // anchors_layer_4->next_scale = 0.8;
...
{
	printf("\n\n########################################################################\n");
	printf("               Generating Anchor Layers Parameters for GAP\n");
	printf("########################################################################\n");
