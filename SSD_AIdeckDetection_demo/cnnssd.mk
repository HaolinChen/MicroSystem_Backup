...
## Enable image send from aideck to pc with wifi
# USE_STREAMER=0
...
ifeq ($(QUANTIZATION_BITS),8)
  ...
  NNTOOL_SCRIPT=model/nntool_SSD_script8
  MODEL_SUFFIX = _SSD_8BIT
else
  ifeq ($(QUANTIZATION_BITS),16)
    GAP_FLAGS += -DQUANTIZATION_16BIT
    NNTOOL_SCRIPT=model/nntool_SSD_script16
    MODEL_SUFFIX = _SSD
  else
...
APP_SRCS += $(MAIN) ImgIO.c ImageDraw.c SSDKernels.c SSDBasicKernels.c SSDParams.c $(MODEL_GEN_C) $(CNN_LIB) 
...
# Add this and wifi can build correctly.
