...
/*
double Original_Data[Time_Num][Sensor_Num]={
        {13,   9.7,  1.5, 6.4},
        {10,   7.5,  1.5, 6.5},
        {20.6, 12.5, 2.3, 7.0},
        {33.3, 19.0, 2.8, 5.8},
...
// Matrix
	...
	Matrix*  mat_1 = Matrix_gen(row,column,&_mat_1[0][0]);
	M_print(mat_1);
	//	Mat_2
	...
	Matrix*  mat_2 = Matrix_gen(row,column,&_mat_2[0][0]);
	M_print(mat_2);
	// Mat_A
	...
	Matrix*  mat_A = Matrix_gen(row,column,&_mat_A[0][0]);
	M_print(mat_A);
	// A_10
	...
	Matrix*  mat_A10 = Matrix_gen(row,column,&_mat_A10[0][0]);
	M_print(mat_A10);
	//	Mat_21
...
//	MATRIX_TYPE _mat_21[3][3] = {0,0,1,0,0,1,0,0,1};
	...
	Matrix*  mat_21 = Matrix_gen(row,column,&_mat_21[0][0]);
	M_print(mat_21);
	//	Mat_21b
	...
	Matrix*  mat_b10 = Matrix_gen(row,column,&_mat_b10[0][0]);
	M_print(mat_b10);
...
//	Operation
	...
	M_print(mat_4);
	Matrix* mat_5 = Etrans_2_Inverse(&_Etrans_,5,_ROW_);
	M_print(mat_5);
	// 上三角变换
