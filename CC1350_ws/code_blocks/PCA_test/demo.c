...
// Matrix
	...
	Matirx*  mat_1 = Matrix_gen(row,column,&_mat_1[0][0]);
	M_print(mat_1);
	//	Mat_2
	...
	Matirx*  mat_2 = Matrix_gen(row,column,&_mat_2[0][0]);
	M_print(mat_2);
	// Mat_A
	...
	Matirx*  mat_A = Matrix_gen(row,column,&_mat_A[0][0]);
	M_print(mat_A);
	// A_10
	...
	Matirx*  mat_A10 = Matrix_gen(row,column,&_mat_A10[0][0]);
	M_print(mat_A10);
	//	Mat_21
...
//	MATRIX_TYPE _mat_21[3][3] = {0,0,1,0,0,1,0,0,1};
	...
	Matirx*  mat_21 = Matrix_gen(row,column,&_mat_21[0][0]);
	M_print(mat_21);
	//	Mat_21b
	...
	Matirx*  mat_b10 = Matrix_gen(row,column,&_mat_b10[0][0]);
	M_print(mat_b10);
